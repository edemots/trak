...
export const transaction = sqliteTable(
  ...
  (table) => [
    ...
    index("td_cat_acc_idx").on(table.tradeDate, table.categoryId, table.bankAccountId),
    index("cat_td_acc_idx").on(table.categoryId, table.tradeDate, table.bankAccountId),
    index("acc_td_cat_idx").on(table.bankAccountId, table.tradeDate, table.categoryId),
    index("acc_cat_td_idx").on(table.bankAccountId, table.categoryId, table.tradeDate),
    index("cat_acc_td_idx").on(table.categoryId, table.bankAccountId, table.tradeDate),
  ],
);
